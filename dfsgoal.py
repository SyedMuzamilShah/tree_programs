...
def goal_driven_dfs(tree, start_node, goal_node):
    ...
    while open_nodes:
        ...
        for parent in reversed(parents):  # reversed to maintain the order in the stack for DFS
...
# # Execute goal-driven DFS
# data = goal_driven_dfs(tree, start_node, goal_node)
